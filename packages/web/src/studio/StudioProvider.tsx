...
import { CANVAS_SIZE, createEmptyFrame, normalizeProject, projectTypeLabel as formatProjectTypeLabel, shouldUseFlipNoteUi, shouldUseStockTickerUi, shouldUseWeatherUi, shouldUseDvdScreensaverUi, shouldUseSpotifyNowPlayingUi, type Frame, type Project, type Rect } from '@pixopen/core';
...
export function StudioProvider({
  ...
  const drawingTools = (() => {
    if (!project || project.type === 'image-frame' || shouldUseFlipNoteUi(project) || shouldUseStockTickerUi(project) || shouldUseWeatherUi(project) || shouldUseDvdScreensaverUi(project) || shouldUseSpotifyNowPlayingUi(project)) return [] as StudioTool[];
