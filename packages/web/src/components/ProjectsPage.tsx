...
import { getAppTemplate, shouldUseFlipNoteUi, shouldUseStockTickerUi, shouldUseWeatherUi } from '@pixopen/core';
              ...
              >
                ...
                <div className="card-body gap-2 p-4 pt-3">
                  ...
                  <p className="text-xs text-muted">
                    ...
                    {project.type === 'live-sign' && !shouldUseFlipNoteUi(project) && !shouldUseStockTickerUi(project) && !shouldUseWeatherUi(project)
